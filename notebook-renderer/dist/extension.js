...
const nteractRenderer_1 = __webpack_require__(2);
function activate(context) {
    console.log(context.extensionPath);
    context.subscriptions.push(vscode.window.registerNotebookOutputRenderer('nteract', {
        type: 'display_data',
        subTypes: [
            'text/latex',
            'text/markdown',
    ...
    }, new nteractRenderer_1.NteractRenderer(context.extensionPath)));
}
...
exports.NteractRenderer = NteractRenderer;
